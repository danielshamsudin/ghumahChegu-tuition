...
export function BottomNav({ userRole, activeTab, onTabChange }) {
  ...
  return (
    <>
      ...
      {/* Bottom Navigation - Floating design, only visible on mobile */}
      <nav className="fixed bottom-4 left-4 right-4 bg-white/90 backdrop-blur-lg rounded-2xl shadow-lg border border-gray-200 sm:hidden z-40">
